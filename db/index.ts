...
const SCHEMA_STATEMENTS = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_profiles_display_name_nocase ON profiles (display_name COLLATE NOCASE)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_membership_interest_status_updated ON membership_interest (status, updated_at)`,
  `CREATE TABLE IF NOT EXISTS user_notifications (id TEXT PRIMARY KEY NOT NULL, user_id TEXT NOT NULL, kind TEXT NOT NULL, title TEXT NOT NULL, message TEXT NOT NULL, payload TEXT, created_at INTEGER NOT NULL, read_at INTEGER)`,
  `CREATE INDEX IF NOT EXISTS idx_user_notifications_user_created ON user_notifications (user_id, created_at)`,
  `CREATE INDEX IF NOT EXISTS idx_user_notifications_unread ON user_notifications (user_id, read_at, created_at)`,
