...
export default function RulesPage() {
  return (
    <main className="rules-page">
      <header className="support-header"><Link className="brand" href="/"><span className="brand-mark">♘</span><span><strong>NoutyChess</strong><small>Fair play</small></span></Link><Link href="/">Voltar ao jogo</Link></header>
      <section className="rules-hero"><span><ShieldCheck /> CÓDIGO DA ARENA</span><h1>Regras da comunidade NoutyChess</h1><p>Competição forte, aprendizado constante e respeito absoluto. Estas regras existem para manter cada partida justa, segura e divertida.</p><small>Versão 1.1 · setembro de 2026</small></section>
      ...
      <footer className="studio-credit"><strong>© 2026 Ekasy Studio</strong><span>NoutyChess · Todos os direitos reservados.</span></footer>
    </main>
  );
}
