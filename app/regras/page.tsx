...
const rules = [
  ...
  { icon: <MessageCircle />, title: '3. Chat e comunidade', items: ['Não envie spam, propaganda repetitiva, links maliciosos ou convites enganosos.', 'Convites de sala devem representar partidas reais e respeitar o ritmo anunciado.', 'O chat é registrado para moderação. Mensagens removidas permanecem na trilha de auditoria administrativa.'] },
  { icon: <LockKeyhole />, title: '4. Segurança e privacidade', items: ['Nunca compartilhe senhas, códigos de acesso ou informações financeiras no chat.', 'A equipe não solicitará senha por mensagem.', 'Tentativas de invadir contas, salas, ranking ou painel administrativo resultam em banimento permanente e preservação dos registros técnicos.'] },
  { icon: <Scale />, title: '5. Ranking, moedas e cosméticos', items: ['Elo muda apenas após partidas ranqueadas confirmadas e validadas.', 'Moedas e recompensas são vinculadas à conta e não podem ser vendidas ou transferidas.', 'Cosméticos não concedem vantagem no tabuleiro. Explorar falhas para duplicar recompensas leva à reversão e punição.'] },
  { icon: <Ban />, title: '6. Punições', items: ['Ações possíveis: aviso, remoção de mensagem, silêncio temporário, perda de recompensas, anulação de partida, suspensão e banimento.', 'A duração considera gravidade, reincidência, intenção e impacto.', 'Evasão de punição por outra conta pode ampliar a sanção.'] },
  { icon: <Gavel />, title: '7. Administração e recursos', items: ['Ações administrativas exigem motivo e ficam registradas.', 'Jogadores podem solicitar revisão por um canal oficial que será divulgado pela Ekasy-Studio.', 'Erros comprovados serão corrigidos; denúncias falsas e abusivas também podem ser moderadas.'] },
  { icon: <ShieldCheck />, title: '8. Integridade do serviço', items: ['Falhas devem ser reportadas, não exploradas.', 'A Ekasy-Studio pode encerrar salas instáveis, invalidar resultados inconsistentes e atualizar estas regras para proteger a comunidade.', 'Continuar usando o jogo após uma atualização significa aceitar a versão vigente das regras.'] },
];
...
export default function RulesPage() {
  return (
    <main className="rules-page">
      ...
      <section className="rules-hero"><span><ShieldCheck /> CÓDIGO DA ARENA</span><h1>Regras da comunidade NoutyChess.pro</h1><p>Competição forte, aprendizado constante e respeito absoluto. Estas regras existem para manter cada partida justa, segura e divertida.</p><small>Versão 1.0 · 31 de agosto de 2026</small></section>
      ...
      <section className="rules-summary"><ShieldCheck /><div><h2>Regra de ouro</h2><p>Jogue com sua própria habilidade, trate pessoas como rivais — nunca como inimigas — e ajude a proteger a arena que todos queremos frequentar.</p></div></section>
