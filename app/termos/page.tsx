...
export const metadata: Metadata = {
  title: 'Termos e direitos | NoutyChess.pro',
  description: 'Termos de uso, fair play e propriedade intelectual do NoutyChess.pro.',
};
...
const sections = [
  {
    ...
    text: 'O NoutyChess.pro é uma plataforma independente de xadrez, comunidade e aprendizado. Ao utilizar o serviço, o jogador concorda em respeitar as regras da comunidade, a integridade das partidas e os demais usuários.',
  },
  {
    icon: <Swords />,
  ...
  },
  {
    ...
    text: '© 2026 Ekasy-Studio. NoutyChess.pro, seu código-fonte próprio, identidade visual, interfaces, sistemas originais, textos, materiais educacionais e ativos produzidos pela Ekasy-Studio são de uso proprietário, salvo quando indicado de outra forma. Bibliotecas de terceiros permanecem sob suas respectivas licenças.',
  },
  {
    icon: <ShieldCheck />,
  ...
  },
  {
    ...
    text: 'O jogo pode receber atualizações de segurança, balanceamento de experiência, recursos sociais, cosméticos e regras. Recursos podem ser ajustados quando necessário para proteger jogadores, infraestrutura e competição justa.',
  },
];
  ...
  return (
    <main className="rules-page">
      ...
      <section className="rules-hero">
        ...
        <p>Regras claras para manter o NoutyChess.pro seguro, justo e sustentável para toda a comunidade.</p>
        <small>Versão 1.0 · 2 de setembro de 2026</small>
      </section>
      ...
      <section className="rules-summary">
        <Copyright />
        <div><h2>Produto independente</h2><p>NoutyChess.pro é desenvolvido pela Ekasy-Studio. O acesso ao jogo não concede licença para copiar, distribuir ou comercializar o código-fonte ou materiais proprietários do projeto.</p></div>
      </section>
